...
public isolated client class ShoppingServiceCheckUserTypeResponseCaller {
    ...
    isolated remote function sendCheckUserTypeResponse(CheckUserTypeResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextCheckUserTypeResponse(ContextCheckUserTypeResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public isolated client class ShoppingServiceRemoveFromCartResponseCaller {
    private final grpc:Caller caller;
    ...
    isolated remote function sendRemoveFromCartResponse(RemoveFromCartResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextRemoveFromCartResponse(ContextRemoveFromCartResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public isolated client class ShoppingServiceViewCartResponseCaller {
    private final grpc:Caller caller;
